...
indicators = {
    "DCA": {
        "Diseño académico": ["Académico", "Conocimiento", "Integral", "Directiva", "Capítulo", "Habilidades", "ANEIAP DAY", "SÉ", "Institucional", "Subdirector", "Subdirectora", "Blandas", "Duras", "Skills", "Académica", "Desarrollo","Estructura curricular", "Evaluaciones", "Planificación académica", "Proyectos interdisciplinarios", "Certificación", "Tutorías", "Recursos didácticos", "Aprendizaje activo", "Plan de estudios", "Gestión académica", "Currículo", "Estrategia pedagógica", "Contenidos", "Planes de estudio", "Metodología", "Innovación curricular", "Evaluación continua", "Aprendizaje activo", "Experiencia educativa", "Capacidades críticas"],
        "Innovación e investigación": ["I+D+I", "Consultoría", "Entorno", "Innovación", "Mentoría", "Ciclo","COEXPRO","Herramienta","Innovación tecnológica", "Investigación aplicada", "Startups", "Colaboración académica", "Transferencia de conocimiento", "Desarrollo sostenible", "Herramientas digitales", "Tendencias globales", "Prototipos", "Publicaciones", "Prototipado", "Investigación aplicada", "Gestión de patentes", "Diseño experimental", "Transferencia tecnológica", "Métodos analíticos", "Innovación disruptiva", "Gestión del conocimiento", "Simulación", "Desarrollo sostenible"],
        "Formación y capacitación": ["Formación", "Escuela", "Liderazgo", "Olimpiadas", "Taller", "FIC", "Ingeolimpiadas", "Capacitación", "Seminario", "Entrenamiento", "Cursos","CEA", "Profesional", "Aplicado", "Simposios", "Diplomados", "Formación continua", "Mentorías", "Charlas técnicas", "Entrenamiento especializado", "Conferencias", "Actividades extracurriculares", "Cursos en línea", "Acreditaciones", "Talleres prácticos", "Acreditaciones", "Modalidad virtual", "Capacitación corporativa", "Programas especializados", "Mentoría grupal", "Competencias técnicas", "Simposios", "Foros interactivos", "Consultorías"]
    },
    "DCC": {
        "Estrategia de comunicación": ["Comunicaciones", "Publicidad", "MIC", "Digital", "Campañas", "Promoción", "Difusión", "Plan de medios", "Estrategia digital", "Gestión de marca", "Posicionamiento", "Interacciones", "Feedback", "Optimización de contenidos", "Segmentación", "Impacto visual", "Mensajería", "Comunicación estratégica", "Relaciones públicas", "Segmentación de audiencia", "Estrategias multicanal", "Copywriting", "Comunicación inclusiva", "Alcance orgánico", "Fidelización", "Medios de comunicación", "Comunicación interna"],
        "Producción audiovisual": ["Redes", "Podcast", "Youtube", "Diseño", "Tiktok", "Audiovisual", "Contenido", "Animaciones", "Infografías", "Live streaming", "Spots publicitarios", "Branding visual", "Microvideos", "Edición avanzada", "Guiones", "Cortometrajes", "Diseño interactivo", "Producción gráfica", "Postproducción", "Conceptos visuales", "Dirección creativa", "Animación 3D", "Grabación en locación", "Edición de video", "Cinematografía", "Guiones audiovisuales", "Calidad de audio"],
        "Gestión de documental": ["Data", "Documental", "Biblioteca", "Documentación", "Archivos digitales", "Preservación de datos", "Control de versiones", "Análisis documental", "Metadatos", "Clasificación", "Digitalización", "Sistemas de recuperación", "Almacenamiento seguro", "Políticas de uso", "Archivo digital", "Gestión de archivos", "Catalogación", "Análisis documental", "Estrategias archivísticas", "Bases de datos", "Gestión electrónica", "Conservación de información", "Indexación", "Control documental"]
    },
    "DCD": {
        "Gestión de asociados": ["Desarrollo", "Directiva", "Capítulo", "ANEIAP DAY", "Expansión", "Cultura", "Reclutamiento", "SÉ", "SRA", "Insignia", "Gestión", "Subdirector", "Subdirectora", "Equipos", "Contacto", "Retención", "Inclusión", "Networking", "Retención de miembros", "Encuestas de satisfacción", "Incentivos", "Programas de membresía", "Coaching", "Fidelización", "Análisis de perfiles", "Adaptación cultural", "Retención asociativa", "Comunicación efectiva", "Base de datos", "Planes de afiliación", "Consultoría asociativa", "Feedback", "Incentivos personalizados", "Encuestas", "Grupos de interés", "Representación"],
        "Integración y bienestar": ["Relaciones", "Gala", "Integraciones", "Premios", "Cohesión", "Personal", "Interpersonal","Talento","Humano","Plan","Incentivo","Clima","RRHH", "Diversidad", "Inclusión social", "Clima organizacional", "Team building", "Salud mental", "Evaluaciones de bienestar", "Workshops", "Liderazgo positivo", "Voluntariado", "Convivencia", "Coaching organizacional", "Cultura asociativa", "Encuentros temáticos", "Planes recreativos", "Conciliación", "Dinámicas grupales", "Redes de apoyo", "Clima laboral", "Recursos humanos", "Bienestar social"],
        "Sostenimiento y sociedad": ["Responsabilidad", "RSA", "Social", "Ambiental", "Comunitario", "Impacto social", "Proyectos comunitarios", "Responsabilidad ambiental", "Conciencia social", "Sostenibilidad organizacional", "Gobernanza", "Gestión ética", "Inclusión económica", "Iniciativas verdes", "Cooperación social", "Emprendimientos sociales", "Responsabilidad corporativa", "Ecoeficiencia", "Proyectos sociales", "Inclusión", "Cooperación", "Relaciones interculturales", "Sustentabilidad", "Educación ambiental", "Ética social"]
    },
    "DCF": {
        "Gestión financieras": ["Finanzas", "Financiero", "Recursos", "Fondos", "Fuente", "Gestión", "Egreso", "Ingreso", "Ahorro", "Dashboard", "Sustentable", "Balance general", "Flujos de efectivo", "Auditorías internas", "Gestión presupuestaria", "Planeación fiscal", "Finanzas sostenibles", "Riesgo financiero", "Revisión de cuentas", "Finanzas públicas", "Rendición de cuentas", "Contabilidad", "Proyecciones", "Capitalización", "Presupuesto anual", "Controles internos", "Flujos de ingresos", "Solidez financiera", "Reportes contables", "Monitoreo financiero", "Planeación fiscal"],
        "Sostenibilidad económica": ["Riqueza", "Sostenibilidad", "Obtención", "Recaudación", "Sostenimiento", "Económica", "Rentabilidad", "Proyectos rentables", "Estrategia económica", "Optimización de costos", "Alternativas financieras", "Planeación a largo plazo", "Viabilidad económica", "Fuentes de ingresos", "Retorno de inversión", "Capital de trabajo", "Costos indirectos", "Microfinanzas", "Diversificación de ingresos", "Estrategia de costos", "Margen bruto", "Evaluación económica", "Planificación financiera", "Modelo financiero", "Recursos sostenibles", "Financiamiento", "Desarrollo económico"],
        "Análisis  y transparencia": ["Directiva", "Capítulo", "Subdirector", "Subdirectora", "Donaciones", "Ética financiera", "Cumplimiento normativo", "Indicadores clave", "Informes de impacto", "Controles internos", "Transparencia organizacional", "Buenas prácticas", "Reportes trimestrales", "Trazabilidad", "Auditorías externas", "Informes trimestrales", "Auditorías externas", "Certificación", "Ética financiera", "Análisis de riesgos", "Validación financiera", "Normativas legales", "Reportes anuales", "Transparencia organizativa", "Gobierno corporativo"]
    },
    "DCM": {
        "Estrategias de brandings": ["Mercadeo", "Branding", "Negocio", "Posicionamiento", "Promoción", "Plan", "Campaña","Stakeholders","SGA","CRM","NPS","Indicador", "Identidad corporativa", "Rebranding", "Estrategia de marca", "Valor de marca", "Posicionamiento estratégico", "Cultura de marca", "Arquitectura de marca", "Narrativa visual", "Diferenciación", "Promesa de marca", "Logo", "Imagen corporativa", "Personalidad de marca", "Slogan", "Marketing emocional", "Arquetipos", "Estilo gráfico", "Identidad visual", "Voz de marca", "Segmentación de clientes"],
        "Promoción y visibilidad": ["Buzón", "Directiva", "Capítulo", "ANEIAP DAY", "Subdirector", "Subdirectora", "Relaciones", "Visibilidad", "Identidad", "Visualización","Saloneo","Red","Expansión", "Estrategias promocionales", "Publicidad segmentada", "Marketing digital", "Engagement", "Campañas omnicanal", "Plan promocional", "Mercadeo de contenidos", "Promociones cruzadas", "Dinámicas interactivas", "Influencer", "Relaciones públicas", "Posicionamiento", "Publicidad programática", "Embajadores de marca", "Networking", "Eventos publicitarios", "Marketing territorial", "Partnerships", "Comunidad digital", "Testimoniales"],
        "Gestión comercial": ["Tienda", "Públicas", "Cliente", "Externo", "Interno", "Modelo", "Servicio", "Venta", "Comercial","EMPRENDE-IAP","Modelo", "Producto", "Servicio","Posicionamiento", "Entorno", "Crecimiento", "Propuestas de valor", "E-commerce", "Negociación comercial", "Canales de distribución", "Estratégias de ventas", "Alianzas comerciales", "Fidelización de clientes", "Embudos de conversión", "Análisis de mercado", "Plan de ventas", "Estrategia de precios", "Modelos de negocio", "Relaciones comerciales", "Cross-selling", "Prospectos", "Base de clientes", "CRM", "Inteligencia comercial", "Marketing relacional", "Canales de venta"]
    },
    "PC": {
        "Liderazgo y estrategia": ["Estrategia", "Directivo", "Liderazgo", "Rendimiento", "Decisiones", "Supervisión", "Transformación","Gestión del cambio", "Toma de decisiones", "Motivación intrínseca", "Comunicación efectiva", "Delegación estratégica", "Desarrollo de equipos", "Pensamiento crítico", "Liderazgo adaptativo", "Visión global", "Estratégias de éxito","Plan estratégico", "Perspectiva global", "Liderazgo transformacional", "Cultura organizacional", "Toma de decisiones", "Resolución de conflictos", "Coaching", "Delegación", "Trabajo en equipo", "Innovación estratégica"],
        "Gestión organizacional": ["Presidencia", "Presidente", "Directiva", "Capítulo", "Junta", "ECAP", "Gestión", "Gestor", "Coordinación", "Procesos operativos", "Diagramas de flujo", "Gestión de riesgos", "Metodologías ágiles", "Revisión estratégica", "Control de calidad", "Benchmarking", "Normativa interna", "Protocolos", "Organización interna", "Procesos administrativos", "Recursos logísticos", "Eficiencia operativa", "Estructura capitular", "Manejo de crisis", "Normativas internas", "Revisión organizacional", "Plan operativo", "Coordinación interdepartamental"],
        "Relaciones y representación": ["Representante", "ANEIAP DAY", "Legal", "Negociaciones", "Relaciones públicas", "Diplomacia", "Visitas institucionales", "Acuerdos estratégicos", "Representatividad", "Relaciones externas", "Resolución de conflictos", "Gestión de imagen", "Agenda oficial", "Diplomacia", "Relaciones institucionales", "Protocolo", "Negociación", "Convenios", "Networking estratégico", "Alianzas", "Representación legal", "Gestión de intereses", "Desarrollo organizacional"]
    },
    "CCP": {
        "Gestión de proyectos": ["Proyecto", "Project", "Asesor", "Sponsor", "Equipo", "Manager", "Gestión", "Vida", "Subcoordinador", "Subcoordinadora", "Viabilidad", "Planificación", "Implementación", "Metodologías PMI", "Diagramas Gantt", "Cronogramas", "Ágil-Scrum", "Recursos humanos", "Stakeholders", "Gestión de alcance", "Cierre de proyectos", "Estimaciones", "Matriz RACI","Metodología ágil", "PMO", "Calendario de proyectos", "Factibilidad", "Stakeholders", "Monitoreo", "Plan de acción", "Alcance del proyecto", "Línea base", "Riesgos del proyecto"],
        "Innovación y creatividad": ["Innovación", "Innova", "Cambio", "Reforma", "ALMA", "Estructura", "Modelo", "Gobierno", "Pensamiento lateral", "Proyectos disruptivos", "Design thinking", "Innovación abierta", "Modelos de negocio", "Colaboración creativa", "Crowdsourcing", "Ideación", "Experimentación", "Validación", "Prototipos", "Diseño conceptual", "Nuevas tecnologías", "Pensamiento lateral", "Creatividad estratégica", "Ideación", "Innovación incremental", "Procesos disruptivos", "Emprendimiento", "Experimentación"],
        "Colaboración estratégica": ["CNI", "GNP", "Directiva", "ECP", "PEN", "COEC", "Capítulo", "Fraternidad", "ANEIAP DAY", "Organización", "Asesoramiento", "Indicadores", "Colaboración", "Sinergias", "Alianzas público-privadas", "Networking estratégico", "Creación de redes", "Gestión de talento", "Análisis de contexto", "Interdisciplinariedad", "Colaboración remota", "Estrategias colaborativas", "Responsabilidad compartida", "Estrategias colaborativas", "Ecosistemas", "Alianzas público-privadas", "Sinergias", "Impacto social", "Modelos de cooperación", "Relaciones multilaterales", "Redes de contacto", "Benchmarking", "Consultoría estratégica"]
    },
    "IC": {
        "Auditoría y control": ["Interventoría", "Normativa", "Auditor", "Interventor", "Datos", "Data", "Análisis", "Ética", "Revisión","Asesoría","Evaluación de riesgos", "Planificación de auditoría", "Verificación", "Procedimientos internos", "Informes de control", "Matriz de evaluación", "Diagnóstico interno", "Checklist", "Indicadores de desempeño", "Seguimiento continuo", "Revisión de procesos", "Calidad", "Supervisión", "Cumplimiento", "Informes de auditoría", "Inspección", "Mejora continua", "Estándares", "Rendición de cuentas", "Control interno"],
        "Normativa y transparencia": ["Transparencia", "Reglamento", "Interventor", "Análisis financiero", "Veeduría","Conducto","Conducta", "Regular", "Reglas de compliance", "Código de conducta", "Reportes públicos", "Declaraciones", "Ética normativa", "Controles regulatorios", "Monitoreo", "Estándares ISO", "Marcos legales", "Transparencia activa", "Políticas", "Estándares éticos", "Marco regulatorio", "Procedimientos", "Control normativo", "Regulaciones", "Transparencia asociativa", "Estrategias de control", "Formalización", "Protocolos"],
        "Seguimiento y evaluación": ["ECI", "360", "Estratégica", "Directiva", "IC", "ENI", "Capítulo", "Interventor", "Rúbrica", "Indicadores de desempeño", "Seguimiento", "KPIs", "Cuadros de mando", "Feedback", "Informe ejecutivo", "Panel de control", "Medición de resultados", "Encuestas", "Monitoreo periódico", "Ajustes estratégicos", "Revisiones iterativas", "Reportes periódicos", "Indicadores de desempeño", "Retroalimentación", "Planes de mejora", "Supervisión constante", "Evaluación cualitativa", "Auditorías internas", "Progreso", "Revisiones", "Evaluación trimestral"]
    }
}
