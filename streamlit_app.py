...
pos_keywords = {
    ...
    "DCC": ["Comunicaciones", "Redes", "Data", "Publicidad", "MIC", "Documental", "Youtube", "Biblioteca", "Podcast", "Directiva", "Capítulo", "Escuela", "Induspod", "Web,", "Journal", "Boletín", "Diseño", "Contenido", "IGTV", "Subdirector", "Subdirectora", "Piezas", "Tiktok", "Audiovisual","Digital","Medios","Información","Campañas","Interacción","Promoción2,"Contenido","Diseño gráfico","Difusión","Corporativo","Producción","Documentación","Branding"],
    "DCD": ["Desarrollo", "Relaciones", "Gala", "Integraciones", "Directiva", "Capítulo", "ANEIAP DAY", "Expansión", "Cultura", "Reclutamiento", "SÉ", "SRA", "Responsabilidad", "Insignia", "RSA", "Saloneos", "Gestión", "Subdirector", "Subdirectora","Equipos","Social","V2,"Premios","Cohesión","Ambiental","Personal","#Interpersonal","Comunitario","Contacto","Retención","Expansión"],
    "DCF": ["Finanzas", "Financiero", "Riqueza", "Sostenibilidad", "Directiva", "Capítulo", "Subdirector", "Subdirectora", "Obtención", "Recursos", "Recaudación", "Fondos", "Fuente", "Financiero","Gestión","Egreso","Ingreso","Sostenimiento","Donaciones","Recaudación","Económica","Rentabilidad","Ahorro","Dashboard","Sustentable"],
    "DCM": ["Mercadeo", "Branding", "Tienda", "Buzón", "Negocio", "Directiva", "Capítulo", "ANEIAP DAY", "Subdirector", "Subdirectora","Relaciones","Públicas","Promoción","Posicionamiento","Cliente","Externo","Interno","Visibilidad","Ngecio","Modelo","Tienda", "Servicio","Branding","Venta","Plan","Identidad","Comercial","Campaña","Visualización"],
