...
pos_keywords = {
    ...
    "DCM": ["Mercadeo", "Branding", "Tienda", "Buzón", "Negocio", "Directiva", "Capítulo", "ANEIAP DAY", "Subdirector", "Subdirectora","Relaciones","Públicas","Promoción","Posicionamiento","Cliente","Externo","Interno","Visibilidad","Modelo", "Servicio","Branding","Venta","Plan","Identidad","Comercial","Campaña","Visualización"],
