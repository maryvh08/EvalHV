...
def extract_experience_section(pdf_path):
    ...
    end_keyword = "Reconocimientos individuales", "EVENTOS ORGANIZADOS", "EXPERIENCIA LABORAL", "DISPONIBILIDAD DE TIEMPO Y MEDIOS DE COMUNICACIÓN","CONDICIONES ECONÓMICAS PARA VIAJAR", "FIRMA"
